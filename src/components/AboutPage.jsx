    ...
    <>
      <main>
        <div className="about-container-one">
          ...
          <div className="container-one-right">
            ...
            <p>
              ...
              smiles and delicious meals since 2012. Our journey began with a
              simple yet passionate idea: to create a space where people can
              savor the joy of delectable cuisine in a cozy and inviting
              atmosphere.
            </p>
          </div>
        </div>
        ...
        <div className="about-container-three">
          <p>
            Chef Olivia Zest is the creative force behind our culinary delights.
            With over two decades of experience in the culinary world, Chef
        ...
        <div className="about-container-four">
          ...
          <p>
            ...
            to the dining table, every aspect of our restaurant is infused with
            a passion for excellence and a commitment to creating unforgettable
